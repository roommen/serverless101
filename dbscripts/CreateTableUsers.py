...
def create_users():
	...
	try:
		...
		cursor.execute('CREATE TABLE Users (UserID DOUBLE NOT NULL AUTO_INCREMENT PRIMARY KEY, FullName VARCHAR(35) NOT NULL, EmailAddress VARCHAR(35) NOT NULL, Password VARCHAR(70) NOT NULL, Location VARCHAR(25) NOT NULL, Comments VARCHAR(155) NOT NULL, Enabled BOOLEAN));')
